                            ...
                            <div class="card-body">
                                <div class="email-left-box"><!-- <a href="email-compose.html" class="btn btn-primary btn-block">Compose</a> -->
                                    <div class="mail-list mt-4">
                                        ...
                                        <a href="/message/trashcan?empno=${ auth.employee.empno }" class="list-group-item border-0 text-primary p-r-0"><i class="fa fa-trash font-18 align-middle mr-2"></i>휴지통 <span class="badge badge-danger badge-sm float-right m-t-5">${ trashMessage }</span> </a>
                                    </div>
                                ...
                                <div class="email-right-box">
                                    ...
                                    <div class="email-list m-t-15">
                                        ...
                                        <div class="message unread">
                                            <a href="/message/trashContent?empno=${ auth.employee.empno }&mno=${ message.mno }">
                                        ...
                                        <table class="table">
	                                        ...
	                                        <c:forEach items="${ messages }" var="message">
	                                            <tr>
	                                                ...
	                                                <td><a href="/message/trashContent?empno=${ auth.employee.empno }&mno=${ message.mno }">${ message.title }</a></td>
                        ...
                        <div class="table-responsive">
                                    ...
                                    <c:if test="${ not empty messages }">
                                        <ul class="pagination justify-content-center">
                                            ...
                                            <li class="page-item ${ pager.pageBlock == 0 ? 'disabled' : '' }"><a class="page-link" href="/message/trashcan?empno=${ auth.employee.empno }&pageNo=${ pager.start -1 }&searchType=${ param.searchType }&searchKey=${param.searchKey}" tabindex="-1">Previous</a></li>
                                            ...
                                            <li class="page-item ${ pager.pageNo == idx ? 'active' : '' }">
                                            	...
                                            	<a class="page-link" href="/message/trashcan?empno=${ auth.employee.empno }&pageNo=${ idx }&searchType=${ param.searchType }&searchKey=${param.searchKey}">${ idx }</a>
                                            	</c:when>
                                            	</c:choose>
                                            </li>
                                            </c:forEach>
                                            
                                            <li class="page-item ${ pager.pageCount < pager.end ? 'disabled' : '' }"><a class="page-link" href="/message/trashcan?empno=${ auth.employee.empno }&pageNo=${ pager.end }&searchType=${ param.searchType }&searchKey=${param.searchKey}">Next</a></li>
