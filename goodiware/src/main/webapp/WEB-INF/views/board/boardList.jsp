										...
										<div class="bootstrap-pagination">
		                                    ...
		                                    <c:if test="${ not empty boards }">
		                                        <ul class="pagination justify-content-center">
		                                            ...
		                                            <li class="page-item ${ pager.pageBlock == 0 ? 'disabled' : '' }"><a class="page-link" href="/board/list?pageNo=${ pager.start -1 }&searchType=${ param.searchType }&searchKey=${param.searchKey}" tabindex="-1">Previous</a></li>
		                                            ...
		                                            <li class="page-item ${ pager.pageNo == idx ? 'active' : '' }">
		                                            	...
		                                            	<a class="page-link" href="/board/list?pageNo=${ idx }&searchType=${ param.searchType }&searchKey=${param.searchKey}">${ idx }</a>
		                                            	</c:when>
		                                            	</c:choose>
		                                            </li>
		                                            </c:forEach>
		                                            
		                                            <li class="page-item ${ pager.pageCount < pager.end ? 'disabled' : '' }"><a class="page-link" href="/board/list?pageNo=${ pager.end }&searchType=${ param.searchType }&searchKey=${param.searchKey}">Next</a></li>
